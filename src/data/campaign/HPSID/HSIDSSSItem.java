...
public class HSIDSSSItem {
    ...
    public HSIDSSSItem(String itemId) {
        this.itemId = itemId;
    }
    ...
    public TooltipMakerAPI createIconImageForPanel(CustomPanelAPI panel) {
        ...
        image.addImage(Global.getSettings().getCommoditySpec(itemId).getIconName(), 60, 0);
        return image;
    }
    ...
    public CustomPanelAPI drawItem(CustomPanelAPI panel) {
        ...
        text.addPara("" + size, Misc.getHighlightColor(), 0);
    ...
    public void addItemStack(CargoAPI cargo) {
        cargo.addItems(type, itemId, size);
    }
    ...
    public void setType(CargoItemType type) {
        this.type = type;
    }
